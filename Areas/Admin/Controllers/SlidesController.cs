...
namespace BTCK_PhanTienDo.Areas.Admin.Controllers
{
    ...
    public class SlidesController : Controller
    {
        ...
        public IActionResult Index(int? page)
        {
            ...
            List<SlidesRecord> listRecord = db.Slides.OrderByDescending(anhxa => anhxa.ID).ToList();
        ...
        public IActionResult Update(int? id)
        {
            ...
            int _id = id ?? 0;
            //lay mot ban ghi
            SlidesRecord record = db.Slides.Where(anhxa => anhxa.ID == _id).FirstOrDefault();
        ...
        public IActionResult Update(IFormCollection fc, int? id)
        {
            ...
            var record = db.Slides.Where(tbl => tbl.ID == id).FirstOrDefault();
            //update ban ghi
            record.Name = _Name;
            //---
